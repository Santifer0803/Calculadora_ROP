...
# Datos de las unidades de pensión

Se cargan los datos de la VANU para cada sexo y se extraen sus valores.

```{r datos_VANU, message = FALSE, warning = FALSE}
vanu.h <- read_excel("data/VANUs 2025.xlsx", sheet = "VANU H")
vanu.m <- read_excel("data/VANUs 2025.xlsx", sheet = "VANU M")

vanu.h <- as.vector(t(vanu.h[9, 4:length(vanu.h)]))
vanu.m <- as.vector(t(vanu.m[9, 4:length(vanu.m)]))
```
